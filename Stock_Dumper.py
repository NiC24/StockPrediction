...
mydata = quandl.get("NSE/TITAN", start_date="2015-01-01", )
dataframe = pd.DataFrame(mydata, columns=['High'])
dataframe.to_csv("Titan/Titan.csv")
new = dataframe.tail(25)
new.to_csv("Titan/Titan-Regression.csv")
# i = 1
...
df2 = pd.read_csv("Titan/Titan-Regression.csv")
df2.to_csv('Titan/Titan-Regression.csv')
